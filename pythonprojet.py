...
Title_Label = Label(Tops,font=('Comic Sans MS',16,'bold'),text = "            Captcha Generator\t\t",bg= 'green',fg='grey',justify ="center")
...
Label_9 =Button(LeftFrame, font=('arial', 19,'bold'), text="Show Text",padx=2,pady=2, bg="blue",fg = "white",command=generate_image_captcha)
Label_9.grid(row=4, column=0)
